...
async function createPdf() {
    // Chromeのインストール場所を指定（例: macOSの場合）
    const browser = await puppeteer.launch({
        executablePath: '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome',  // Macの場合
        // Linuxの場合は、例えば /usr/bin/google-chrome を指定する
        // Windowsの場合は、例: 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe'
    ...
    const htmlContent = `
        <html>
            <head>
                ...
                .templates-selected-pricecard-wrapper {
                  margin-top: -28px;
                  padding-bottom: 5px;
                ...
                .templates-selected-pricecard-label {
                  font-size: 12px;
                }

                .templates-selected-pricecard {
                  font-weight: bold;
                  margin-top: 0px;
                }

                .templates-pdf-creates {
                  margin-left: 20px;
                }

                .templates-pef-create-input {
                  padding: 10px 25px;
                ...
                .template_modal-shadow {
                  ...
                  opacity: 0; /* 最初は見えない */
                  transition: opacity 0.3s ease-in-out; /* 1秒でフェードイン */
                }
                ...
                .template_image-name {
                  ...
                  font-size: 10px;
                  white-space: nowrap;
                }/*# sourceMappingURL=car_template.css.map */
                </style>
            </head>
            <body>
                ...
                <div class="card" id="">
                    ...
                    <div class="headers">
                        ...
                        <div class="header_right">
                            <img src="./img/HELLO.jpeg" alt="" class="header_logo">
                        </div>
                    </div>
                    <!-- 車両情報部分 -->
                    <div class="names">
                        ...
                        <div class="jcs">
                            <div class="jcs_inner">
                                <div class="japanese_calendar">R</div>
                                <div class="registration_year">3</div>
                                <div class="jc-unit">年</div>
                                <div class="registration_month">12</div>
                    ...
                    <div class="mains">
                        <div class="payment-tags">
                            <div class="payment-tags_inner">
                                <img src="./img/logo.png" alt="" class="payment-img">
                                <div class="payment-text">支払総額</div>
                            </div>
                        </div>
                        <div class="total-prices">
                            <div class="total-prices_inner">
                                <div class="total-price">162</div>
                            </div>
                        </div>
                        <div class="recycles">
                            ...
                            <div class="total-price_dots-wrapper">
                                <div class="total_price-dot_inner">
                                    ...
                                    <div class="total-price-dpf">9</div>
                                </div>
                    ...
                    <div class="price-ohde">
                        ...
                        <div class="ohde-wrapper">
                            ...
                            <div class="ohdes">
                                <div class="ohde">10</div>
                                <div class="ohde-dot">.</div>
                                <div class="ohde-dpf">1</div>
                            </div>
                            <div class="ohde-uom">万円</div>
                        </div>
                        <div class="price-ohde-text">
                            支払総額は<span class="price-ohde-month">12</span>月現在、<span class="price-ohde-city">青森市内</span>登録(届出)で店頭納車の場合の価格です。<br>
                                ...
                                <div class="vi-tables_wrapper">
                                    <div class="tr vi_wrapper">
                                        ...
                                        <div class="td vi_jc_wrapper">
                                            <div class="vi_jc">R</div>
                                            <div class="vi_year">6</div>
                                            <div class="vi_year-tag">年</div>
                                            <div class="vi_month">12</div>
                                            <div class="vi_month-tag">月</div>
                                            <div class="vi_day">12</div>
                                    ...
                                    <div class="tr mileage_tr">
                                        ...
                                        <div class="td">
                                            <div class="mileage_k-km">148</div>
                                            <div class="mileage_k-km-tag">千<span>km</span></div>
                                            <div class="brackets-first">〔</div>
                                            <div class="mileage_km">48,000</div>
    ...
    await page.pdf({ path: '/Users/ryotaishito/Document/workspace/CarPricePro/output.pdf', format: 'A4' });
